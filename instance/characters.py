...
山小 = CharacterPortrait(
    path="images/portrait/山小.png",
    character_name="山小",
    score=75,
)
弗尔弗尔 = CharacterPortrait(
    path="images/portrait/弗尔弗尔.png",
    character_name="弗尔弗尔",
    score=50,
)
新贞 = CharacterPortrait(
    path="images/portrait/新贞.png",
    character_name="新贞",
    score=50,
)
小贝 = CharacterPortrait(
    path="images/portrait/小贝.png",
    character_name="小贝",
    score=50,
)
...
剑大师 = CharacterPortrait(
    path="images/portrait/剑大师.png",
    character_name="剑大师",
    score=25,
)
苏尔 = CharacterPortrait(
    path="images/portrait/苏尔.png",
    character_name="苏尔",
    score=25,
)
